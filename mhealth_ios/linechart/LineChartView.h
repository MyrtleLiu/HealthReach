...
@property (readonly) NSInteger missPre; // should be within the y range
...
@property NSInteger xLabelCount;

@property NSInteger isWatch;
...
@property BOOL drawsBG;
@property BOOL enableTouch;
