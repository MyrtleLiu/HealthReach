...
CGFloat buttonSpacerHeight = 0.0f;
CGFloat buttonPaddingBottom = 20.0f;

CGFloat showOpacity = 0.92f;
CGFloat hideOpacity = 0.0f;
...
- (void)show
{
    ...
    dialogView.layer.opacity = hideOpacity;
    dialogView.layer.transform = CATransform3DMakeScale(1.3f, 1.3f, 1.0);
    
    self.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:hideOpacity];
    ...
    [UIView animateWithDuration:0.2f delay:0.0 options:UIViewAnimationOptionCurveEaseInOut
					 animations:^{
						 self.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:showOpacity/4];
                         dialogView.layer.opacity = showOpacity;
...
- (IBAction)buttonTouchUpInside:(id)sender
{
    ...
    if (onButtonTouchUpInside != NULL) {
        ...
        onButtonTouchUpInside(self, (int32_t)tag);
    }
}
...
- (void)close
{
    ...
    dialogView.layer.opacity = 0.95f;
    
    [UIView animateWithDuration:0.2f delay:0.0 options:UIViewAnimationOptionTransitionNone
					 animations:^{
						 self.backgroundColor = [UIColor colorWithRed:0.0f green:0.0f blue:0.0f alpha:hideOpacity];
...
- (UIView *)createContainerView
{
    if (containerView == NULL) {
        containerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 260, 150)];
    }
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i< count; i++) {
        ...
        if (count==1) {
            buttonHeight = 35.0f;
            buttonWidth = 118.0f;
            [closeButton setFrame:CGRectMake((container.bounds.size.width-buttonWidth)/2, container.bounds.size.height - buttonHeight -buttonPaddingBottom, buttonWidth, buttonHeight)];
            [closeButton setBackgroundImage:[UIImage imageNamed:@"00_btn_green_p1"] forState:UIControlStateNormal];
        }else{
            [closeButton setFrame:CGRectMake(i * buttonWidth, container.bounds.size.height - buttonHeight -buttonPaddingBottom, buttonWidth, buttonHeight)];
        }
        ...
        [closeButton.titleLabel setFont:[UIFont fontWithName:@"HelveticaNeueLTPro-Md" size:20]];
