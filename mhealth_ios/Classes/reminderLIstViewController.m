...
- (void)viewDidLoad
{
    ...
    [_btnClick setTitle:[Utility getStringByKey:@"Add Event"] forState:UIControlStateNormal];
    NSString *lanuage = [Utility getLanguageCode];
    if([lanuage isEqualToString: @"en"]){
        [_demonpic setImage:[UIImage imageNamed:@"slide6_3.PNG"]];
    }
    else{
        [_demonpic setImage:[UIImage imageNamed:@"slide6_3zh.PNG"]];
...
-(IBAction)btnClick:(id)sender{
    ...
    AddReminderFirstViewController *_allchar=[[AddReminderFirstViewController alloc]initWithNibName:@"AddReminderFirstViewController" bundle:nil];
